...
vim.keymap.set('n', '<leader>tt', '<cmd>Neotree toggle filesystem<CR>', { desc = 'Toggle File Tree' })
vim.keymap.set('n', '<leader>tg', '<cmd>Neotree float git_status<CR>', { desc = 'Toggle File Tree' })
vim.keymap.set('n', '<leader>tb', '<cmd>Neotree toggle buffers<CR>', { desc = 'Toggle File Tree' })
